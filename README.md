...
(2016)](https://arxiv.org/abs/1606.06642) for details and cite this reference togehter with the [software DOI]((https://doi.org/10.5281/zenodo.3484711) for the specific code version employed, if you are using SMASH. A BibTeX entry for the software DOI is found on the respective Zenodo pages.
