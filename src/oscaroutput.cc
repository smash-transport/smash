 ...
 * \process_type{46} Hard string excitation, non-diffractive. A hard
 *                   2 &rarr; 2 QCD process is generated by PYTHIA. Here
 *                   quarks or gluons scatter at parton level before the
 *                   strings are formed.
 * \process_type{48} Hard string excitation, single diffractive AB &rarr; AX.
 *                   Generated by PYTHIA with a hard diffractive process.
 * \process_type{49} Hard string excitation, single diffractive AB &rarr; XB.
 *                   Generated by PYTHIA with a hard diffractive process.
 * \process_type{50} Hard string excitation, double diffractive. Generated by
 *                   PYTHIA with a hard diffractive process.
 * \process_type{51} Failed string process. A string process can fail due to
 *                   lack of energy. This tag is added to avoid mislabeling the
 *                   event.
