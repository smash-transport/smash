 ...
 *                   strings are formed.
 * \process_type{47} Hard string excitation, single diffractive AB &rarr; AX.
 *                   Generated by PYTHIA with a hard diffractive process.
 * \process_type{48} Hard string excitation, single diffractive AB &rarr; XB.
 *                   Generated by PYTHIA with a hard diffractive process.
 * \process_type{49} Hard string excitation, double diffractive. Generated by
 *                   PYTHIA with a hard diffractive process.
 * \process_type{50} Failed string process. A string process can fail due to
