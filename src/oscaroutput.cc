 ...
 * <tr><td>\key t, \key x, \key y, \key z<td> \c double <td>Space-time
 coordinates</tr>
 * <tr><td>\key mass<td>\c double <td>Particle's rest-mass </tr>
 * <tr><td>\key p0, \key px, \key py, \key pz<td> \c double <td>Energy and
 3-momentum</tr>
 * <tr><td>\key pdg<td>\c int32_t<td>PDG code of the particle (see
 http://pdg.lbl.gov/). It contains all quantum numbers and uniquely identifies
 its type</tr>
 * <tr><td>\key ID, id<td> \c int32_t <td>Particle identifier in terms of an
 ...
 * <tr><td>\key charge<td>\c int32_t <td>Electric charge of the particle in
 units of the elementary charge e</tr>
 * <tr><td>\key ncoll<td>\c int32_t <td>Number of collisions the particle has
 undergone</tr>
 * <tr><td>\key form_time<td>\c double <td>Formation time of the particle</tr>
 * <tr><td>\key xsecfac<td>\c double <td>Cross section scaling factor (if the
 ...
 factor)</tr>
 * <tr><td>\key proc_id_origin<td>\c int32_t <td>ID of the process of the
 ...
 * <tr><td>\key pdg_mother1<td> \c int32_t <td>PDG code of the 1st mother
 particle (0 in case the particle is sampled in a thermal bubble. It is not
 updated by elastic scatterings.)</tr>
 * <tr><td>\key pdg_mother2<td> \c int32_t <td>PDG code of the 2nd mother
 particle (0 in case the particle results from the decay of a resonance or the
 appearance of a thermal bubble. In the former case, \key pdg_mother1 is the PDG
 code of this resonance. It is not updated by elastic scatterings.)</tr>
 * <tr><td>\key baryon_number<td> \c int32_t <td>Baryon number of the particle.
 1 for baryons, -1 for anti-baryons and 0 for mesons</tr>
 * <tr><td>\key strangeness<td> \c int32_t <td>Net-strangeness of the
 particles</tr>
