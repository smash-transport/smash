...
//     f_.emplace_back(
//         InterpolateLinear<T>(x_[i], y_sorted[i], x_[i + 1], y_sorted[i +
//         1]));
//   }
// }
//
...
// }
//
/// Represent a bilinear spline interpolation.
class InterpolateData2DSpline {
 public:
   ...
   */
  InterpolateData2DSpline(const double x[], const double y[], const double z[],
  ...
  /**
   * Calculate bicubic interpolation at x and y.
   *
