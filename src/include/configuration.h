 ...
 * all particles. Anti particles don't have to be specified explicitely.
 *
 ...
 *
 * Note that some reactions in SMASH a parametrized and require specific
 ...
 *
 * All possible decays in SMASH are given by the `decaymodes.txt` file by blocks
 ...
 * ratios in one block don't add up to 1, they are automatically normalized by
 * SMASH.
 *
