 ...
 * reactions scatterings. Note, that all 2-to-2 reactions, in particular \key "PiDeuteron_to_NN", are included except
 * the d' reactions, since they effectively yield the same reaction. Before using the example, if important, check for completeness of all 2-to-2 reactions (potentially out of date).
 *
 *\verbatim
 Collision_Term:
