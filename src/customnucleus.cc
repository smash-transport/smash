 ...
 *
 *   \note SMASH is shipped with an example configuration file to set up a
 * collision with externally generated nucleon positions. This requires a
 * particle list to be read in. Both, the configuration file and the particle
 * list, are located in /input/custom_nucleus. To run SMASH with the provided
 * example configuration and particle list, execute \n
 * \n
 * \verbatim
