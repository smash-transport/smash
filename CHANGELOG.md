...
### Added
* Implemented 2 -> 2 cross sections for D meson-light meson scatterings (pions, etas, kaons) as an additional option beside the treatment via intermediate resonances.
