...
* ⚠️  The `Total_Cross_Section_Strategy` key determines how the total cross sections for collision finding are evaluted, whether from summing the partial contributions or using a parametrization.
