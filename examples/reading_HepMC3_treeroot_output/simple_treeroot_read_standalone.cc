...
public :
    ...
    std::vector<int>     links1;                                  ///< Relations between particles and vertices, see HepMC documentation, HepMC trees only
    std::vector<int>     links2;                                  ///< Relations between particles and vertices, see HepMC documentation, HepMC trees only
    std::vector<int>     attribute_id;                            ///< HepMC event attribute id, see HepMC documentation, HepMC trees only
    std::vector<std::string>  attribute_name;                          ///< HepMC event attribute name , see HepMC documentation, HepMC trees only
    std::vector<std::string>  attribute_string;                        ///< HepMC event attribute string, see HepMC documentation, HepMC trees only
    std::vector<double>  weights;
    std::vector<std::string>  tool_name;   ///< Name of the program that generated the data               
    std::vector<std::string>  tool_version;   ///< Version of the program that generated the data                     
