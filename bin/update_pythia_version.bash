...
function find_current_pythia_version()
{
    ...
    pythia_version_in_readme=$(grep 'Pythia' ${smash_sources_root_dir}/README.md | grep -Eo '[1-9]?[0-9]\.[0-9]{3}' | sort -u)
...
function change_pythia_version()
{
    ...
    ( cd "${smash_sources_root_dir}" && \
      files_to_be_processed=( README.md INSTALL.md .github/workflows/**.yml cmake/** containers/**/Dockerfile \
                              examples/**/README.md src/CMakeLists.txt ) && \
