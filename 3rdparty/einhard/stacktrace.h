 ...
 *
 * It is licensed under the WTFPL v2.0, which is GPL-compatible.
 *
 * (c) 2008, Timo Bingmann from http://idlebox.net/
 *
 */

#ifndef SRC_INCLUDE_STACKTRACE_H_
#define SRC_INCLUDE_STACKTRACE_H_
...
#endif  // SRC_INCLUDE_STACKTRACE_H_
