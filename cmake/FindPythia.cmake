...
ELSE()
  ...
  STRING(REGEX MATCH "pythia[0-9]([0-9][0-9][0-9])" _ ${Pythia_prefix})
  SET(Pythia_VERSION_MINOR ${CMAKE_MATCH_1})
  SET(Pythia_VERSION ${Pythia_VERSION_MAJOR}.${Pythia_VERSION_MINOR})
  if(${Pythia_VERSION} VERSION_LESS ${Pythia_FIND_VERSION})
    MESSAGE( STATUS "** INSUFFICIENT Pythia version: ${Pythia_VERSION},"
  ...
  endif(${Pythia_VERSION} VERSION_LESS ${Pythia_FIND_VERSION})
ENDIF()
